...
function evaluatePathways(metrics) {
  ...
  cards.push(makePathway(
    'Polytechnic Year 1',
    polyThreshold ? 'possible' : 'not-yet',
    polyThreshold
      ? 'You meet the 4 G3 + 1 G2-equivalent threshold. Detailed cluster fit still matters, but G3 Mathematics is not compulsory in the cluster-fit view below.'
